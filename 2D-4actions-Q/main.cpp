...
void dis_qvalue(int e);
void sum_qvalue(int e);
...
void qlearning()
{
	int observation, action, observation_,reward;
	double q_target;
	...
	for (e = 0; e < episodes; e++)
	{
		...
		while (1)
		{
			...
			if (reward == 1)
				...
				q_target = reward + gamma*q[observation_][max_action(observation_)];
